...
export default {
  ...
  plugins: [
    execute([
      ...
      ` cp -f ${currentDir}/manifest.json ${currentDir}/obsidian_local_images_plus_latest/manifest.json`,
      ` cp -f ${currentDir}/styles.css ${currentDir}/obsidian_local_images_plus_latest/styles.css`,
    ]),
    typescript(),
